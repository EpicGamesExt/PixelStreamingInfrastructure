...
/**
 * A UI element showing the QP (quantization parameter) of the video stream at the last encoded frame (well,
 * last transmitted QP really). A blockier encoding will have a higher QP and this will make the indicator
 * turn more red. A non-blocky stream will have a lower QP and this will make the indicator turn more green.
