...
export class PixelStreamingApplicationStyle {
  ...
  defaultStyles = {
    ...
    '.clickableState': {alignItems: 'center', justifyContent: 'center', display: 'flex', cursor: 'pointer'},
  ...
  constructor(options?: {
    ...
    const jssOptions = {
      ...
      // plugins: [functions(), template(), global(), extend(), nested(), compose(), camelCase(),
      // defaultUnit(options.defaultUnit), expand(), vendorPrefixer(), propsSort()]
