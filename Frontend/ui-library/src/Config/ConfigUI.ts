...
export class ConfigUI {
  ...
  populateSettingsElement(settingsElem: HTMLElement): void {
    ...
    if (preferredCodecOption &&
        [...preferredCodecOption.selector.options].map((o) => o.value).includes('Only available on Chrome')) {
  ...
  /**
   * Add a numeric setting element to a particular settings section in the DOM and registers that flag in the
   * Config.numericParameters map.
   * @param settingsSection - The settings section HTML element.
   * @param settingFlag - The settings flag object.
   */
  ...
  /**
   * Add an enum based settings element to a particular settings section in the DOM and registers that flag in
   * the Config.enumParameters map.
   * @param settingsSection - The settings section HTML element.
   * @param settingFlag - The settings flag object.
   */
