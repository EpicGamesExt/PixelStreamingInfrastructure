...
import {Config, Flags, FlagsIds, Logger, NumericParameters, NumericParametersIds, OptionParameters, OptionParametersIds, SettingBase, SettingFlag, SettingNumber, SettingOption, SettingsChangedEvent, SettingText, TextParameters, TextParametersIds} from '@epicgames-ps/lib-pixelstreamingfrontend-ue5.5';
...
export class ConfigUI {
     ...
     * @param settingsElem - - The element that contains all the individual settings sections, flags, and so
     *     on.
     */
    ...
    /**
     * Add a SettingText element to a particular settings section in the DOM and registers that text in the
     * text settings map.
    ...
    /**
     * Add a SettingFlag element to a particular settings section in the DOM and registers that flag in the
     * Config.flag map.
     * @param settingsSection - The settings section HTML element.
    ...
    /**
     * Add a numeric setting element to a particular settings section in the DOM and registers that flag in
     * the Config.numericParameters map.
     * @param settingsSection - The settings section HTML element.
     * @param settingFlag - The settings flag object.
     */
    ...
    /**
     * Add an enum based settings element to a particular settings section in the DOM and registers that flag
     * in the Config.enumParameters map.
     * @param settingsSection - The settings section HTML element.
     * @param settingFlag - The settings flag object.
     */
