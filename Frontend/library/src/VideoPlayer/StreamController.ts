...
export class StreamController {
  ...
  handleOnTrack(rtcTrackEvent: RTCTrackEvent) {
    ...
    // Do not add the track if the ID is `probator` as this is special track created by mediasoup for bitrate
    // probing. Refer to https://github.com/EpicGamesExt/PixelStreamingInfrastructure/pull/86 for more
    // details.
