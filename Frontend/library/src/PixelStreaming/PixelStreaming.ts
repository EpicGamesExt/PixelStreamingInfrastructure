    ...
    private configureSettings(): void {
        this.config._addOnSettingChangedListener(
            ...
            (wantsQualityController: boolean) => {
                // If the setting has been set to true (either programmatically or the user has flicked the
                // toggle) and we aren't currently quality controller, send the request
