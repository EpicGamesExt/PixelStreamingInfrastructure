...
export class FileUtil {
    ...
    static setContentsFromBytes(view: Uint8Array, file: FileTemplate) {
        ...
        if (file.data.length === file.size) {
             ...
             *
             * This code reconstructs the received data into the original file based on the mime type and
             * extension provided and then downloads the reconstructed file
             */
