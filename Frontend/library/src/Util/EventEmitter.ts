...
export class WebRtcDisconnectedEvent extends Event {
    ...
    readonly data: {
        ...
        eventString: string;
        /**
           true if the user is able to reconnect, false if disconnected because of unrecoverable reasons like
           not able to connect to the signaling server
         */
...
export class StreamerListMessageEvent extends Event {
    ...
    readonly data: {
        ...
        /**
           Auto-selected streamer from the list, or null if unable to auto-select and user should be prompted
           to select
         */
